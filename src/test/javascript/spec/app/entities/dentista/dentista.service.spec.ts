...
describe('Service Tests', () => {
  describe('Dentista Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(DentistaService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Dentista(0, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Dentista', async () => {
        const returnedFromService = Object.assign(
          {
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
