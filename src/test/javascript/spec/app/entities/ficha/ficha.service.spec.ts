...
describe('Service Tests', () => {
  describe('Ficha Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Ficha(0, 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Ficha', async () => {
      ...
      it('should update a Ficha', async () => {
        const returnedFromService = Object.assign(
          {
            month: 'BBBBBB',
            urgency: true
      ...
      it('should return a list of Ficha', async () => {
        const returnedFromService = Object.assign(
          {
            month: 'BBBBBB',
            urgency: true
      ...
      it('should delete a Ficha', async () => {
