...
import com.control.shift.config.audit.AuditEventConverter;
import com.control.shift.domain.PersistentAuditEvent;
...
import static com.control.shift.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
